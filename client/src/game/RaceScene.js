...
function buildTrackMesh() {
  ...
  for (let index = 0; index < 28; index += 1) {
    ...
    const stripe = new THREE.Mesh(new THREE.BoxGeometry(2.4, 0.03, 0.3), lineMaterial);
    stripe.position.set(
  ...
  const finishLine = new THREE.Mesh(
    new THREE.BoxGeometry(0.8, 0.04, 8),
...
export class RaceScene {
  constructor(container) {
    ...
    this.tempCameraOffset = new THREE.Vector3(0, 7, -14);
  ...
  updateCamera(delta) {
    ...
    this.tempCameraOffset.set(0, 7, -14);
